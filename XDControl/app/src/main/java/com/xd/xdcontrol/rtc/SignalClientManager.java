...
import com.xd.xdcontrol.ChatActivity;
...
//    public static String clentID = "学生1";
    private static String address = "ws://" + Const.DEFAULT_IP;
    ...
    public void onOpen(ServerHandshake handshakedata) {
        ...
        try {
            ...
            message.put("id", StatusParser.getInstance().getClientId());
    ...
    private void onRemoteOfferReceived(JSONObject message) {
        try {
            ...
            int youxian = message.getInt("youxian");
            ChatActivity.openActivity(mContext, false, "laoshi", null, description, youxian);
        } catch (JSONException e) {
