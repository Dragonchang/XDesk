...
abstract class BaseActivity<B : ViewBinding> : AppCompatActivity(), View.OnClickListener {
    ...
    var mqttManager = XDApplication.mApplication.mqttService
...
//    abstract fun getLayoutID(): Int
    ...
    override fun onStart() {
        super.onStart()
        robotApp.bindMqttService { service ->
            Log.d("BaseActivity", "Service bound: ${service?.getConnectedClients()}")
        }
    }
