...
extern "C"
JNIEXPORT jint JNICALL
Java_com_xd_lib_1can_android_1socketcan_socketcanWrite(JNIEnv *env, jobject thiz, jint fd,
...
Java_com_xd_lib_1can_android_1socketcan_socketcanRead(JNIEnv *env, jobject thiz, jint fd) {
    jlongArray ret;
